...
// const img ='./assets/images/blog2.png'
...
<div className={style.containerDiv}>
           ...
           <div className={style.blue}>Шаг 1: Определитесь с типом юрисдикции</div>
            <p className={style.p}>
В ОАЭ существует три основные формы регистрации:<br />
Free Zone (Свободные экономические зоны) — выгодны для иностранных предпринимателей, позволяют 100% владение бизнесом.<br />
Mainland (наземная юрисдикция) — подходит, если вы хотите работать напрямую с местными компаниями и государственными структурами.<br />
