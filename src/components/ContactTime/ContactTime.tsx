    ...
    <section>
      ...
      <div className={style.sectionContainer}>
        ...
        <div className={style.container}>
          ...
          <div>
            {" "}
            <p className={style.title2}>{tr("business")} </p>
            <p className={style.title2}>{tr("adress2")}</p>
          </div>
        </div>

        <div className={style.containerEmail}>
          <div>
            <Image src={email} alt="email" width={24} height={19} />
            <a className={style.aEmail} href="#">
              info.xyz@gmail.com
            </a>
          </div>
          <div>
            {" "}
            <Image src={tell} alt="tell" width={24} height={24} />
            <a className={style.aEmail} href="#">
              +996 476-924
            </a>
          </div>
        ...
        <div className={style.containerIcon}>
          ...
          <a href="">
            <Image src={twiter} alt="twitter" width={32} height={32} />
          </a>
          <a href="">
