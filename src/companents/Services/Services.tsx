...
export function Services(){
    return <section className={stylle.sectionContainer}>
        <div className={stylle.serversContainer}>
            <h2 className={stylle.serverH2}>Services that cover everything from incorporation to operating businesses</h2>
            <p className={stylle.serverP}>You can choose an individual service or entrust us with a turnkey solution. We adapt to your goals and budget.</p>
        </div>
